...
function App() {
  ...
  return (
    ...
    <div style={{height:"100vh"}} className='d-flex w-100 justify-content-center align-items-center bg-dark' >
      ...
      <Button type='submit' style={{width:'200px',height:'70px'}}  disabled={isPrinciplevalid && isRatevalid && isYearvalid?false:true} variant="contained"  className='bg-primary'>CALCULATE</Button>
